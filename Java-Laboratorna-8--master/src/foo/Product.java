...
public class Product implements Comparable<Product>{
   ...
   /* public void writeObjectToFile(Product object) throws IOException {
    ...
    public Product(String name, LocalDate dateoOfCreation, int shelfTime,double price,int id) {
        this.name = name;
        this.dateOfCreation = dateoOfCreation;
        this.shelfTimes = shelfTime;
        this.price=price;
    ...
    public Product(String name, LocalDate dateoOfCreation, int shelfTime,double price,int id,int origin_id) {
        this.name = name;
        this.dateOfCreation = dateoOfCreation;
        this.shelfTimes = shelfTime;
        this.price=price;
